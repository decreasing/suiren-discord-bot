...
module.exports.run = async (bot, message, args) => {
    ...
    embed.setDescription(`**admin** paid ${args[1]} credits to **${bot.users.cache.get(user.id).username}**`);
    embed.addField("New Balance:", `${money[user.id].money} credits`);
